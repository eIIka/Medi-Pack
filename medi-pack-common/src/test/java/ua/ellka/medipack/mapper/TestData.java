...
public class TestData {
    ...
    public static final MedicalMaterialDTO MEDICAL_MATERIAL_DTO = new MedicalMaterialDTO(
            10L, MATERIAL_NAME, MEASUREMENT_UNIT, USER_ID);
    ...
    public static final PackageMaterialDTO PACKAGE_MATERIAL_DTO = new PackageMaterialDTO(
            20L, MEDICAL_PACKAGE.getId(), MEDICAL_MATERIAL_DTO, QUANTITY, SPECIFICATION, USER_ID);
    public static final PackageMaterialShortDTO PACKAGE_MATERIAL_SHORT_DTO = new PackageMaterialShortDTO(
            20L, MATERIAL_NAME, MEASUREMENT_UNIT, QUANTITY, SPECIFICATION, USER_ID);

    // MEDICAL PACKAGE
    public static final MedicalPackageDTO MEDICAL_PACKAGE_DTO = new MedicalPackageDTO(
            100L, CODE, CONTEXT, List.of(PACKAGE_MATERIAL_SHORT_DTO), USER_ID);
    ...
    public static final UsedPackageDTO USED_PACKAGE_DTO = new UsedPackageDTO(
            500L, MEDICAL_PACKAGE_DTO, QUANTITY_USED, DATE, USER_ID);
